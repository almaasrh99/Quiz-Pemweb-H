...
(function ($) {
  ...
  $.fn.fancyMessenger = function (options) {
    ...
    var fancyMarkup = $(
      '<div class="fancyMessenger"><div class="fancyMessenger-header"><div class="fancyMessenger-avatar"><div class="fancyMessenger-available">&check;</div></div><div class="fancyMessenger-text">' +
        settings.text.heading +
        '</div></div><div class="fancyMessenger-body">' +
        settings.text.body +
        '</div><div class="fancyMessenger-info"></div></div>'
    );
